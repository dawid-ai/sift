...
export type WhisperBinarySource =
  | { kind: "archive"; assetUrl: string; sha256: string; version: string; binaryName: string }
  | { kind: "homebrew" };
...
const ARCHIVE: Partial<Record<Platform, { name: string; sha256: string }>> = {
  "win-x64": { name: "whisper-bin-x64.zip", sha256: "7d8be46ecd31828e1eb7a2ecdd0d6b314feafd82163038ab6092594b0a063539" },
  "win-arm64": { name: "whisper-bin-x64.zip", sha256: "7d8be46ecd31828e1eb7a2ecdd0d6b314feafd82163038ab6092594b0a063539" },
  "linux-x64": { name: "whisper-bin-ubuntu-x64.tar.gz", sha256: "f3bf3b4369a99b54665b0f19b88483b30de27f25963b0414235dea03198515c5" },
  "linux-arm64": { name: "whisper-bin-ubuntu-arm64.tar.gz", sha256: "e0b66cd551ff6f2a28fabe3c6e89691eea037bb76833493abb9a71ca788994b3" },
};
